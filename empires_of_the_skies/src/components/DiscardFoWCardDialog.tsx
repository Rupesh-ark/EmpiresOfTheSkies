...
const DiscardFoWCardDialog = (props: MyGameProps) => {
  ...
  return (
    <Dialog open maxWidth="sm" fullWidth>
      <DialogTitle>Discard Fortunes of War Cards</DialogTitle>
      <DialogContent>
        <Typography variant="body2" sx={{ mb: 2 }}>
          Your hand exceeds {maxCards} cards. Discard down to {maxCards} by clicking cards to remove.
          ...
          {hand.map((card, i) => (
            <Button
              ...
              sx={{
                ...
                textTransform: "none",
                border: "2px solid",
                borderColor: card.sword > 0 ? "#c62828" : card.shield > 0 ? "#1565c0" : "#757575",
                color: "text.primary",
              }}
            >
