...
function buildEmptyMap() {
  ...
  for (let r = 0; r < ROWS; r++) {
    ...
    for (let c = 0; c < COLS; c++) {
      buildings[r][c] = { fort: [], garrisonedRegiments: 0, garrisonedLevies: 0 };
...
describe("Legacy Cards — the builder (+2 per building)", () => {
  it("grants +2 VP per cathedral, palace, shipyard, and fort", () => {
    ...
    G.mapState.buildings[0][0] = { player: G.playerInfo["0"], fort: ["0"], garrisonedRegiments: 0, garrisonedLevies: 0, garrisonedEliteRegiments: 0 };
...
describe("Legacy Cards — the conqueror (+6 per colony)", () => {
  it("grants +6 VP per colony", () => {
    ...
    G.mapState.buildings[0][0] = { player: G.playerInfo["0"], buildings: "colony", fort: [], garrisonedRegiments: 0, garrisonedLevies: 0, garrisonedEliteRegiments: 0 };
    G.mapState.buildings[0][1] = { player: G.playerInfo["0"], buildings: "colony", fort: [], garrisonedRegiments: 0, garrisonedLevies: 0, garrisonedEliteRegiments: 0 };
    const vpBefore = G.playerInfo["0"].resources.victoryPoints;
    legacyResolutions(G);
  ...
  it("does NOT grant VP for outposts", () => {
    const G = setupPlayer({ name: "the conqueror", colour: "purple" });
    G.mapState.buildings[0][0] = { player: G.playerInfo["0"], buildings: "outpost", fort: [], garrisonedRegiments: 0, garrisonedLevies: 0, garrisonedEliteRegiments: 0 };
    const vpBefore = G.playerInfo["0"].resources.victoryPoints;
    legacyResolutions(G);
...
describe("Legacy Cards — the navigator (+4 VP per outpost and colony)", () => {
  it("grants 4 VP per outpost and colony on the map", () => {
    ...
    G.mapState.buildings[0][2] = { player: G.playerInfo["0"], buildings: "outpost", fort: [], garrisonedRegiments: 0, garrisonedLevies: 0, garrisonedEliteRegiments: 0 };
    G.mapState.buildings[1][3] = { player: G.playerInfo["0"], buildings: "colony", fort: [], garrisonedRegiments: 0, garrisonedLevies: 0, garrisonedEliteRegiments: 0 };
    G.mapState.buildings[2][1] = { player: G.playerInfo["0"], buildings: "outpost", fort: [], garrisonedRegiments: 0, garrisonedLevies: 0, garrisonedEliteRegiments: 0 };
    const vpBefore = G.playerInfo["0"].resources.victoryPoints;
    legacyResolutions(G);
