...
export const buildPlayerInfoMap = (ctx: Ctx): { [id: string]: PlayerInfo } => {
  ...
  ctx.playOrder.forEach((playerID: string) => {
    ...
    playerIDMap[playerID] = {
      ...
      fleetInfo: [
        { fleetId: 0, location: [4, 0], skyships: 0, regiments: 0, levies: 0, eliteRegiments: 0, travelHistory: [] },
        { fleetId: 1, location: [4, 0], skyships: 0, regiments: 0, levies: 0, eliteRegiments: 0, travelHistory: [] },
        { fleetId: 2, location: [4, 0], skyships: 0, regiments: 0, levies: 0, eliteRegiments: 0, travelHistory: [] },
      ],
      cathedrals: 1,
      palaces: 1,
