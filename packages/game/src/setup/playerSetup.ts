...
import { PlayerInfo, PlayerColour } from "../types.js";
import { colourToKingdomMap, STARTING_RESOURCES, BASE_GOLD_INCOME, HERESY_MIN } from "../data/gameData.js";
import { initialBattleMapState } from "./boardSetup.js";
...
export const buildPlayerInfoMap = (ctx: Ctx): { [id: string]: PlayerInfo } => {
  ...
  ctx.playOrder.forEach((playerID: string) => {
    ...
    playerIDMap[playerID] = {
      ...
      fleetInfo: [
        { fleetId: 0, location: [4, 0], skyships: 0, regiments: 0, levies: 0, eliteRegiments: 0, travelHistory: [], dispatchedThisRound: false },
        { fleetId: 1, location: [4, 0], skyships: 0, regiments: 0, levies: 0, eliteRegiments: 0, travelHistory: [], dispatchedThisRound: false },
        { fleetId: 2, location: [4, 0], skyships: 0, regiments: 0, levies: 0, eliteRegiments: 0, travelHistory: [], dispatchedThisRound: false },
      ],
      cathedrals: 1,
      palaces: 1,
      heresyTracker: HERESY_MIN,
      prisoners: 0,
      freeDissenters: 0,
      piracyIntent: "tax",
